        ...
        <header className="navbar">
            <div className="navbar-left">
                <Link to="/" className="logo">
                    <img src="/images/logo.jpg" alt="ABC Company Logo" />
                ...
                <ul className="nav-menu">
                    ...
                    >
                        ...
                        <ul className="dropdown">
                            <li><Link to="/products/industrial-chemicals">Product Category</Link></li>
                            <li><Link to="/products/waxes">Waxes</Link></li>
                            <li><Link to="/products/wax-emulsions">Product Category</Link></li>
                        </ul>
                    </li>
                    ...
                    >
                        ...
                        <ul className="dropdown">
                            ...
                            <li><Link to="/services/diesel-exhaust-fluid">Product Two</Link></li>
                        </ul>
                    </li>
