...
const DEPT_LABELS = {
    ...
    waxEmulsions: "Product Category Sales",
...
const Contact = () => {
    ...
    return (
        <>
            <Title>Contact ABC Company | Request Info or Quote</Title>
            <Meta
                name="description"
                content="Get in touch with ABC Company for general inquiries, Product Category sales, or wax blending and packaging solutions. Our team is ready to assist you."
            />
                    ...
                    <div className="contactus-content-grid">
                        ...
                        <div className="contactus-info" aria-label="Contact Information">
                            ...
                            <address>
                                ...
                                <a href="tel:123-456-7890" aria-label="Call office">(804) 733-7628</a><br />
                                <strong>Fax:</strong> (804) 733-7698<br />
                                <strong>Email:</strong>{" "}
                                <a href="mailto:info@example.com" aria-label="Email office">info@example.com"contactus-dept">
                                <h3>For Waxes, Blending and Packaging:</h3>
                                <div>
                                    <strong>Blake Myers</strong><br />
                                    Phone: <a href="tel:123-456-7890" aria-label="Call Blake Myers">(908) 227-5151</a><br />
                                    Email: <a href="mailto:blakem@dominionchemical.com" aria-label="Email Blake Myers">blakem@dominionchemical.com</a>
                                </div>
                                <h3>For Product Category Sales:</h3>
                                <div>
                                    <strong>Dan Spurlock</strong><br />
                                    Technical Sales Consultant<br />
                                    Phone: <a href="tel:123-456-7890" aria-label="Call Dan Spurlock office">(804) 733-7628</a><br />
                                    Cell: <a href="tel:123-456-7890" aria-label="Call Dan Spurlock cell">(804) 586-2022</a><br />
